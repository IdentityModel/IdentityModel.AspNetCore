...
namespace Bff.InMemoryTests
{
    ...
    /// </summary>
    public class FakeBffUserAccessAccessTokenManagementService : IUserAccessTokenManagementService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private static readonly ConcurrentDictionary<string, Lazy<Task<AuthenticationProperties>>> SynConcurrentDictionary = new();
        ...
        public FakeBffUserAccessAccessTokenManagementService(
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (parameters.ChallengeScheme.IsNullOrWhiteSpace())
            {
                parameters.ChallengeScheme = "oidc";
            }
